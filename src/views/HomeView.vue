...
<template>
  ...
  <div class="p-8">
    ...
    <div class="flex items-center">
        ...
        <HomeCard image="https://picsum.photos/id/89/300/300" title="Title is here" subTitle="Subtitle is here"/>
        <HomeCard class="md:block hidden" image="https://picsum.photos/id/90/300/300" title="Title is here" subTitle="Subtitle is here"/>
        <HomeCard class="lg:block hidden" image="https://picsum.photos/id/91/300/300" title="Title is here" subTitle="Subtitle is here"/>
        <HomeCard class="xl:block hidden" image="https://picsum.photos/id/92/300/300" title="Title is here" subTitle="Subtitle is here"/>
    </div>
  </div>
  ...
  <div class="p-8">
    ...
    <div class="py-1.5"></div>
    <div class="flex items-center">
        <HomeCard image="https://picsum.photos/id/94/300/300" title="Title is here" subTitle="Subtitle is here"/>
        <HomeCard image="https://picsum.photos/id/95/300/300" title="Title is here" subTitle="Subtitle is here"/>
        <HomeCard class="md:block hidden" image="https://picsum.photos/id/98/300/300" title="Title is here" subTitle="Subtitle is here"/>
