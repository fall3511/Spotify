...
<template>
  <div>
      ...
      <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
        ...
        <div class="flex items-center">
          <img class="rounded-full" width="27"
            src="https://yt3.ggpht.com/rAXEfWi-mxP6ZuFUYaNh5DVQTwRtRCdeikFC0Ru-KV6w91F151zyTDbyCz0-9zm02iga45JLXg=s88-c-k-c0x00ffffff-no-rj">
          <div class="text-white text-[14px] ml-1.5 font-semibold">Fall</div>
    ...
    <div id="SideNav" class="h-[100%] p-6 w-[240px] fixed z-50 bg-black">
      ...
      <ul>
        <li class="font-semibold text-[13px] mt-3 text-gray-100 hover:text-white">All</li>
        <li class="font-semibold text-[13px] mt-3 text-gray-100 hover:text-white">Some</li>
        <li class="font-semibold text-[13px] mt-3 text-gray-100 hover:text-white">Indie</li>
        <li class="font-semibold text-[13px] mt-3 text-gray-100 hover:text-white">Pop</li>
      </ul>
    </div>
  </div>
